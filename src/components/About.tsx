...
export const About = () => {
  ...
  return (
    <section id="about" className="py-24 px-4 bg-slate-900 border-t border-slate-800">
          ...
          <div className="md:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className="p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 hover:border-brand-primary/50 transition-colors"
              >
                <div className="w-12 h-12 rounded-xl bg-brand-primary/20 text-brand-light flex items-center justify-center mb-4">
                  {skill.icon}
                </div>
